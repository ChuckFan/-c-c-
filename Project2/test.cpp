//题目描述：给定一个字符串和一个词典dict，
//确定s是否可以根据词典中的词分成一个或多个单词。
//比如，给定  s = "leetcode"  dict = ["leet", "code"]  返回true，
//因为"leetcode"可以被分成"leet code"
...
public:
	bool wordBreak(string s, unordered_set<string> &dict)
	{
		...
		vector<bool> can_break(s.size() + 1, false);        // 初始化F(0) = true        can_break[0] = true;
